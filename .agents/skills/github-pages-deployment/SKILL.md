...
- Lay outs (`Layout.astro`, `AmpLayout.astro`) and components (`Navigation.astro`) construct all root-relative paths by dynamically prefixing them with `import.meta.env.BASE_URL`.
