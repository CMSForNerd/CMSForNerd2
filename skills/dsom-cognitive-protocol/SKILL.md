...
- id: workspace_file
  title: SKILL.md
  url: skills/dsom-cognitive-protocol/SKILL.md
generated:
...
This skill governs the integration and execution of the Deep State of Mind (DSOM) cognitive framework across all operating AI Agent environments (such as Google Jules and Google Antigravity).

## When to use this skill

- When initializing an AI agent session or reanimating cognitive state.
- When tracking task progress in `.agents/brain/task.md` or session logs in `walkthrough.md`.
- When updating AI rules in `AGENTS.md` and `.agents/AGENTS.md`.

## Operational Standards & Procedures

### 1. Zero-Global / Spatial Memory Protocol
